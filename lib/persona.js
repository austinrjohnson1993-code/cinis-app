const PERSONA_DEFS = {
  drill_sergeant: {
    ...
    lengthRule: 'Be blunt. Skip pleasantries. Use short punchy sentences.',
  },
  coach: {
    label: 'The Coach',
    ...
    lengthRule: 'Lead with warmth, follow with direction. One encouraging observation, one action.',
  },
  thinking_partner: {
    ...
    lengthRule: 'Ask one good question. Don\'t tell them what to do — help them see it.',
  },
  hype_person: {
    ...
    lengthRule: 'One genuine celebration, one energetic push. Keep it punchy not cheesy.',
  },
  strategist: {
    ...
    lengthRule: 'State the facts. Give the logical next move. Skip the emotion.',
  },
}
...
export function buildPersonaPrompt(profile) {
  ...
  return `You are FocusBuddy — a personal coach who texts like a smart friend, not a therapist.
